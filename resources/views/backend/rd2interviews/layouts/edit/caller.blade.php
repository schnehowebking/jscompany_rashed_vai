<div id="" class="content mt-2 col-md-6">
    ...
    <div class="row mt-2">
        <div class="col-md-3">
            ...
            <input type="text" value="{{ $rd2Caller->name_or_ste }}" name="caller_info_name_or_ste"
                class="form-control" />
        </div>
        <div class="col-md-3">
            <label class="form-label" for="caller_info_first_name">First Name</label>
            <input type="text" value="{{ $rd2Caller->first_name }}" name="caller_info_first_name"
                class="form-control" />
        </div>
        <div class="col-md-3">
            <label class="form-label" for="caller_info_current_address">Current Address</label>
            <input type="text" value="{{ $rd2Caller->current_address }}" name="caller_info_current_address"
                class="form-control" />
        </div>
        <div class="col-md-3">
            ...
            <select name="caller_info_municipality" class="form-control">
                <option {{ $rd2Caller->municipality == '97319 Awala-Yalimapo' ? 'selected' : '' }}
                    value="97319 Awala-Yalimapo">97319 Awala-Yalimapo</option>
                <option {{ $rd2Caller->municipality == '97330 Camopi' ? 'selected' : '' }} value="97330 Camopi">97330
                    Camopi</option>
                <option {{ $rd2Caller->municipality == '97340 Grand-Santi' ? 'selected' : '' }}
                    value="97340 Grand-Santi">97340 Grand-Santi</option>
                <option {{ $rd2Caller->municipality == '97350 Iracoubo' ? 'selected' : '' }} value="97350 Iracoubo">
                    97350 Iracoubo</option>
                <option {{ $rd2Caller->municipality == '97310 Kourou' ? 'selected' : '' }} value="97310 Kourou">97310
                    Kourou</option>
                <option {{ $rd2Caller->municipality == '97355 Macouria' ? 'selected' : '' }} value="97355 Macouria">
                    97355 Macouria</option>
                <option {{ $rd2Caller->municipality == '97318 Mana' ? 'selected' : '' }} value="97318 Mana">97318 Mana
                </option>
                <option {{ $rd2Caller->municipality == '97360' ? 'selected' : '' }} value="97360">97360</option>
                <option {{ $rd2Caller->municipality == '97370 Maripasoula' ? 'selected' : '' }}
                    value="97370 Maripasoula">97370 Maripasoula</option>
                <option {{ $rd2Caller->municipality == '97351 Matoury' ? 'selected' : '' }} value="97351 Matoury">97351
                    Matoury</option>
                <option {{ $rd2Caller->municipality == '97356 Montsinéry-Tonnegrande' ? 'selected' : '' }}
                    value="97356 Montsinéry-Tonnegrande">97356 Montsinéry-Tonnegrande</option>
                <option {{ $rd2Caller->municipality == '97380 Ouanary' ? 'selected' : '' }} value="97380 Ouanary">97380
                    Ouanary</option>
                <option {{ $rd2Caller->municipality == '97316 Papaichton' ? 'selected' : '' }}
                    value="97316 Papaichton">97316 Papaichton</option>
                <option {{ $rd2Caller->municipality == '97353 Régina' ? 'selected' : '' }} value="97353 Régina">97353
                    Régina</option>
                <option {{ $rd2Caller->municipality == '97390' ? 'selected' : '' }} value="97390">97390</option>
                <option {{ $rd2Caller->municipality == '97354 Remire-Montjoly' ? 'selected' : '' }}
                    value="97354 Remire-Montjoly">97354 Remire-Montjoly</option>
                <option {{ $rd2Caller->municipality == '97311 Roura' ? 'selected' : '' }} value="97311 Roura">97311
                    Roura</option>
                <option {{ $rd2Caller->municipality == '97352' ? 'selected' : '' }} value="97352">97352</option>
                <option {{ $rd2Caller->municipality == '97312 Saint-Élie' ? 'selected' : '' }}
                    value="97312 Saint-Élie">97312 Saint-Élie</option>
                <option {{ $rd2Caller->municipality == '97313 Saint-Georges' ? 'selected' : '' }}
                    value="97313 Saint-Georges">97313 Saint-Georges</option>
                <option {{ $rd2Caller->municipality == '97320 Saint-Laurent-du-Maroni' ? 'selected' : '' }}
                    value="97320 Saint-Laurent-du-Maroni">97320 Saint-Laurent-du-Maroni</option>
                <option {{ $rd2Caller->municipality == '97314 Saül' ? 'selected' : '' }} value="97314 Saül">97314 Saül
                </option>
                <option {{ $rd2Caller->municipality == '97315 Sinnamary' ? 'selected' : '' }} value="97315 Sinnamary">
        ...
        <div class="col-md-3">
            ...
            <input type="text" class="form-control" value="{{ $rd2Caller->profession }}"
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_type_of_contract">
                <option {{ $rd2Caller->type_of_contract == 'C.D.I' ? 'selected' : '' }} value="C.D.I">C.D.I</option>
                <option {{ $rd2Caller->type_of_contract == 'C.D.D' ? 'selected' : '' }} value="C.D.D">C.D.D</option>
                <option {{ $rd2Caller->type_of_contract == 'CONCTRACTUAL' ? 'selected' : '' }} value="CONCTRACTUAL">
                    CONCTRACTUAL</option>
                <option {{ $rd2Caller->type_of_contract == 'Official' ? 'selected' : '' }} value="Official">Official
                </option>
                <option {{ $rd2Caller->type_of_contract == 'GERANT' ? 'selected' : '' }} value="GERANT">GERANT
                </option>
                <option {{ $rd2Caller->type_of_contract == 'WITHOUT ACTIVITY' ? 'selected' : '' }}
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_professional_maturity_months">
                ...
                @for ($i = 1; $i <= 12; $i++)
                <option value="{{ '+' . $i }}"
                    {{ $rd2Caller->professional_maturity_months == '+' . $i ? 'selected' : '' }}>
                    +{{ $i }}
                </option>
                @endfor
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_bank_name">
                @foreach (['BRED-Banque Populaire', 'Savings Bank', 'Caisse de Crédit Mutuel', 'The Postal Bank', 'BNP Paribas Antilles Guyana', 'Crédit Agricole Martinique-Guyane', 'CASDEN Banque Populaire'] as $bank)
                    <option value="{{ $bank }}" {{ $rd2Caller->bank_name == $bank ? 'selected' : '' }}>
                        {{ $bank }}
                    </option>
                @endforeach
        ...
        <div class="col-md-3">
            ...
            <input type="text" class="form-control" value="{{ $rd2Caller->avings_info }}"
                name="caller_info_savings_info">
        </div>
        <div class="col-md-3">
            <label class="form-label" for="caller_info_annual_tax_income">Annual Tax Income</label>
            <input type="number" class="form-control" value="{{ $rd2Caller->annual_tax_income }}"
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_child_dependent_on_tax">
                @for ($i = 1; $i <= 7; $i++)
                    <option value="{{ $i }}"
                        {{ $rd2Caller->child_dependent_on_tax == $i ? 'selected' : '' }}>
                        {{ $i }}
                    </option>
                @endfor
            </select>
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control" value="{{ $rd2Caller->rental_charge }}"
                name="caller_info_rental_charge">
        </div>
        <div class="col-md-3">
            <label class="form-label" for="caller_info_rental_income">Rental Income</label>
            <input type="number" class="form-control" value="{{ $rd2Caller->rental_income }}"
                name="caller_info_rental_income">
        </div>
        <div class="col-md-3">
            <label class="form-label" for="caller_info_rental_income_70_percent">Rental Income
                (70%)</label>
            <input type="number" class="form-control" value="{{ $rd2Caller->rental_income_70_percent }}"
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_bank_seniority_months">
                ...
                @for ($i = 1; $i <= 12; $i++)
                <option value="{{ '+' . $i }}"
                    {{ $rd2Caller->bank_seniority_months == '+' . $i ? 'selected' : '' }}>
                    +{{ $i }}
                </option>
                @endfor
            </select>
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_seniority_pel_months">
                ...
                @for ($i = 1; $i <= 12; $i++)
                <option value="{{ '+' . $i }}"
                    {{ $rd2Caller->seniority_pel_months == '+' . $i ? 'selected' : '' }}>
                    +{{ $i }}
                </option>
                @endfor
            </select>
        ...
        <div class="col-md-3">
            <label class="form-label" for="caller_info_credit_remaining_to_settle">Credit Remaining to
                Settle</label>
            <input type="number" class="form-control" value="{{ $rd2Caller->credit_remaining_to_settle }}"
        ...
        <div class="col-md-3">
            <label class="form-label" for="caller_info_credit_a_in_progress_per_month">Credit in
                progress
                permonth</label>
            <input type="number" class="form-control" value="{{ $rd2Caller->credit_a_in_progress_per_month }}"
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control"
                value="{{ $rd2Caller->remaining_month_credit_a_in_progress }}"
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="caller_info_family_situation">
                <option {{ $rd2Caller->family_situation == 'Pacified' ? 'selected' : '' }} value="Pacified">Pacified
                    (e)</option>
                <option {{ $rd2Caller->family_situation == 'Married' ? 'selected' : '' }} value="Married">Married (e)
                </option>
                <option {{ $rd2Caller->family_situation == 'Divorced' ? 'selected' : '' }} value="Divorced">Divorced
                    (é)</option>
                <option {{ $rd2Caller->family_situation == 'Cohabitation' ? 'selected' : '' }} value="Cohabitation">
                    Cohabitation</option>
                <option {{ $rd2Caller->family_situation == 'Bachelor' ? 'selected' : '' }} value="Bachelor">Bachelor
                </option>
        ...
        <div class="col-md-3">
            <label class="form-label" for="caller_info_personal_contribution">Personal
                Contribution</label>
            <input type="number" class="form-control" value="{{ $rd2Caller->personal_contribution }}"
