{{-- RD2CoBorrowerInformation Table: --}}
<div class="col-md-3">
...
<div class="col-md-3">
  <label class="form-label" for="rental_income_70_percent">Rental Income 70 Percent</label>
...
<div class="col-md-3">
  <label class="form-label" for="credit_a_in_progress_per_month">Credit A In Progress Per Month</label>
...
<div class="col-md-3">
  <label class="form-label" for="remaining_month_credit_a_in_progress">Remaining Month Credit A In Progress</label>
...
{{-- HouseholdResourceCapacity Table: --}}
...
<div class="col-md-3">
  <label class="form-label" for="annual_rental_income_before_abatement">Annual Rental Income Before Abatement</label>
  <input type="text" class="form-control" name="annual_rental_income_before_abatement">
</div>

<div class="col-md-3">
  <label class="form-label" for="annual_rental_income_after_abatement">Annual Rental Income After Abatement</label>
  <input type="text" class="form-control" name="annual_rental_income_after_abatement">
</div>

<div class="col-md-3">
  <label class="form-label" for="potential_help_financial_assistance">Potential Help Financial Assistance</label>
  <input type="text" class="form-control" name="potential_help_financial_assistance">
</div>

<div class="col-md-3">
  <label class="form-label" for="financial_capacity_of_household">Financial Capacity Of Household</label>
  <input type="text" class="form-control" name="financial_capacity_of_household">
</div>


{{-- HouseholdDuctment Table: --}}
...
<div class="col-md-3">
  <label class="form-label" for="non_loan_financing_capacity">Non Loan Financing Capacity</label>
