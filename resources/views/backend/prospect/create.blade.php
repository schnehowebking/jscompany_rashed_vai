                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 d-flex justify-content-between">
                        ...
                        {{-- <button type="submit" class="btn btn-primary btn-submit">
                            <span class="d-sm-inline-block d-none me-sm-1">Submit</span>
                        ...
                        <button type="button" class="step-trigger">
                            <span class="bs-stepper-icon">
                                <svg viewBox="0 0 54 54">
                                    <use
                                        xlink:href='{{ asset('assets/svg/icons/form-wizard-account.svg#wizardAccount') }}'>
                                    </use>
                                </svg>
                            </span>
                            <span class="bs-stepper-label">Prospect Details</span>
                        </button>
                    </div>
