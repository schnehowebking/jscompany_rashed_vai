  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        {{-- <img src="{{asset('assets/img/backgrounds/solar-panel.jpg')}}" alt="Auth Cover Bg color" width="520" class="img-fluid authentication-cover-img" data-app-light-img="pages/reset-password-light.png" data-app-dark-img="pages/reset-password-dark.png"> --}}
        <div class="mx-auto">
      ...
      <div class="w-px-400 mx-auto">
        ...
        <div class="app-brand justify-content-center mb-4">
          <a href="{{url('/')}}" class="app-brand-link gap-2 mb-2">
            ...
            @if(!app_setting('logo'))
              <span class="app-brand-text demo h3 mb-0 fw-bold">{{app_setting('appname')}}</span>
            @endif
          </a>
        </div>
        <!-- /Logo -->
